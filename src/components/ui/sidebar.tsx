      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-white p-0 text-black"
            style={
              {
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <span className="text-base font-normal align-middle border border-gray-400 rounded px-2 py-0.5 bg-white/80">메뉴보기</span>
    </Button>
  )
})
