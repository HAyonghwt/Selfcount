...
export default function RefereePage() {
    ...
    const handleStartScoring = () => {
        if (selectedGroup && selectedCourse && selectedJo) {
            ...
            toast({ title: "선택 필요", description: "그룹, 코스, 조를 모두 선택해주세요.", variant: "destructive" });
        }
    };
    ...
    const renderSelectionScreen = () => (
        <Card>
            ...
            <CardFooter>
                <Button size="lg" className="w-full h-14 text-lg" onClick={handleStartScoring} disabled={!selectedGroup || !selectedCourse || !selectedJo}>
                    점수기록 시작
                </Button>
            </CardFooter>
        </Card>
